...
function RubikCube(element, params)
{
	...
	this.background = "#4BCFFF";	// canvas background color
	this.colors = ["#4EF551","#4ECAF5","#FFFFFF","#FFE500","#F08B21","#EF5C3F"];	// face colors
	...
	this.shiny = 0;	// 0 = flat faces, 0.25 = shiny faces
